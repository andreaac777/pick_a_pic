...
export const HERO_VIDEO_SRC = "https://ik.imagekit.io/jrse0akla/hero.mp4?updatedAt=1775191213849";

export const SHOWCASE_BG_VIDEO_SRC =
    "https://ik.imagekit.io/jrse0akla/showcase.mp4?updatedAt=1775259705034";
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
    ...
    },
    {
        ...
        body: "Pick a Pic restyles the image while protecting composition, identity cues, and the small details that matter.",
        icon: SparklesIcon,
        featured: true,
    },
];